...
- [Assignment 1](assignments/assignment_1.md)
  - Please see [Assignment 1 Notes](assignment_1/assignment_1_notes.md) for notes on how to run and analyse results.
- [Assignment 2](assignments/assignment_2.md)
  - Please see [Assignment 2 Notes](assignment_2/assignment_2_WRITEUP.md) for notes on how to run and analyse results.
